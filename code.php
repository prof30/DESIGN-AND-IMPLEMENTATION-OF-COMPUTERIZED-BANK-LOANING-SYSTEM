...
if(strlen($_SESSION['accountnumber'])=="")
    ...
    header("Location: index.php");
        ...
        if(isset($_POST['transfer'])){
            ...
            }elseif(($code)=="08164293279"){
                header("Location: profile.php");
                echo "<script> alert('Account has been credited') </script>";
            }else{
                echo "<script> alert('Invalid Code enter.. Contact Customer Care') </script>";
            }
...
<label for="default" class="col-sm-2 control-label">Enter OTP Sent to your mobile phone</label>
<div class="col-sm-10">

<input type="text" name="code" class="form-control" id="fullanme" required="required" autocomplete="off">
</div>
</div>
...
<button type="submit" name="transfer" class="btn btn-primary">Transfer</button>
        ...
        <script>
            $(function(){
                ...
                toastr["success"]( "Welcome to my code!");
