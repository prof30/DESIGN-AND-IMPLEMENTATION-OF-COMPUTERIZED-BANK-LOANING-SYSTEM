		...
		<div class="header-w3mdl"><!-- header-two --> 
			<div class="container"> 
				<div class="agileits-logo navbar-left">
					<h1><a href="index.php"> <img src="images/e.png" alt="logo" width="20%"/>Banking and loan System</a></h1> 
				</div> 
				<div class="agileits-hdright nav navbar-nav">
					<div class="header-w3top"><!-- header-top --> 
						<ul class="w3l-nav-top">
							<li><i class="fa fa-phone"></i><span> +234 816 429 3279 </span></li> 
							<li><a href="mailto:example@mail.com"><i class="fa fa-envelope-o"></i><span>mail@umbonline.com</span></a></li>
						</ul>
					...
					<div class="agile_social_banner">
						<ul class="agileits_social_list">
							...
							<li><a href="admin/index.php" class="w3_agile_vimeo">Admin</a> </li>
						</ul>
