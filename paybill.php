...
<label for="default" class="col-sm-2 control-label">Payment for:</label>
<div class="col-sm-10">
...
<button type="submit" name="transfer" class="btn btn-primary">Pay Bill</button>
</div>
</div>
</form>
