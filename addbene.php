...
if(!empty($accountnumber) && !empty($bankname) && !empty($amount) && !empty($Description)){
    echo "<script> alert('Beneficiary Added') </script>";
...
<div class="form-group">
<label for="default" class="col-sm-2 control-label">Bank Name</label>
<div class="col-sm-10">
...
<button type="submit" name="add" class="btn btn-primary">Add Beneficairy</button>
</div>
</div>
</form>
