...
if(strlen($_SESSION['admin'])=="")
    ...
    header("Location: index.php");
        ...
        if(isset($_GET['accountnumber']) AND !empty($_GET['accountnumber'])){
            $id = $_GET['accountnumber'];
            $approves = 1;
            $remark = "Approved";
            $sucess = $con->query("UPDATE loan SET approval = '$approves', remark = '$remark' WHERE accountnumber = '$id' ");
            if($sucess){
                echo "<script> alert('You Have Approved the loan') </script>";
...
<html lang="en">
	...
	?>
                                        <tr>
                                            ...
                                            <td>
                                            <a class="btn btn-xs btn-primary" href="loan.php?accountnumber=<?php echo $show['accountnumber']; ?>"><i class="fa fa-edit"></i></a>
             		  <a class="btn btn-xs btn-danger" onclick="return confirm('Are you sure you want to Applicant? ')" href="#"><i class="fa fa-trash"></i></a>
