...
//}else{
    if(isset($_POST['register'])){
        ...
        $con->query("INSERT INTO `admin` VALUES('', '$username', '$password')") or die(mysqli_error());
                    ...
                    <div class="col-lg-4 col-md-5">
                        <div class="div-trans text-center">
                           ...
                           <form action="" class="form-signin" method="post" role="form">
								...
								<br>
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary btn-block" id="login" name="register">Register</button>
                               
									</p>
                                </div>
                             </div>
                </form>
                <a href = "index.php"><button type="submit" class="btn btn-primary btn-block" id="login" name="">Login</button></a>
                        </div>
                    </div>
