...
if(strlen($_SESSION['admin'])=="")
    ...
    $up_emp=("UPDATE `account` SET `fullname` = '$fullname',`acctName` = '$acctName', `Address` = '$address', `Email` = '$emailid', `phone` = '$phone', `gender` = '$gender', `status` = '$status', `dob` = '$dob', `state` = '$state', `lga` = '$lga' WHERE `acctNumber` = $acctNumber");
  
 $success = $con->query($up_emp);
 if($success){
...
<div class="col-sm-10">
<input type="text" name="fullname" class="form-control" id="fullanme" value="<?php echo $show['fullname'];?>"  required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="text" name="accountName" value="<?php echo $show['acctName'];?>" class="form-control" id="fullanme" required="required" autocomplete="off">
</div>
</div>
...
<label for="AccountNumber" class="col-sm-2 control-label">Account Number</label>
<div class="col-sm-10">
<input type="text" name="AccountNumber" class="form-control" id="fullanme" value="<?php echo $show['acctNumber'];?>"  required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="text" name="address" value="<?php echo $show['Address'];?>" class="form-control" id="rollid" maxlength="20" required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="email" name="emailid" value="<?php echo $show['Email'];?>" class="form-control" id="email" required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="tel" name="phone" value="<?php echo $show['phone'];?>" class="form-control" id="phone" required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="date"  name="dob" value="<?php echo $show['dob'];?>" class="form-control" id="date">
  </div>
 </div>
