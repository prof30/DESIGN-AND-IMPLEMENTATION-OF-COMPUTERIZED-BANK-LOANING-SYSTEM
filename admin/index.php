    ...
    <div id="home" >
        <div class="overlay">
            <div class="container">
                ...
                <a href = "../index.php"><button type="submit" class="btn btn-primary btn-block" id="login" name="register">Back Home</button></a>
                        </div>
                    </div>
				...
				<div class="span3"><img class="index_logo img-responsive" height="500" width="700" src="assets/img/logocalca.png"></div>
